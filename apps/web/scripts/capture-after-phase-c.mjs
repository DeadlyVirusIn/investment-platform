// After-screenshots — Phase 0+A+B+C visual parity work.
import { chromium } from 'playwright';
import path from 'node:path';
import { fileURLToPath } from 'node:url';
const __dirname = path.dirname(fileURLToPath(import.meta.url));
const OUT = path.resolve(__dirname, '..', '..', '..', 'docs', 'research', 'Screenshots', 'visual-parity-after-phase-c-2026-05-23');
const HOST = 'http://localhost:5174';
const PAGES = [
  { slug: 'today', path: '/v2/today' },
  { slug: 'learn', path: '/v2/learn' },
  { slug: 'lesson', path: '/v2/learn/lesson/reading-a-thesis' },
  { slug: 'try', path: '/v2/try/reading-a-thesis' },
  { slug: 'me', path: '/v2/me' },
