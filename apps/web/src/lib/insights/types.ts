...
// F4: optional cache provenance chip. "hit" = served from
// agent_insight cache, "miss" = freshly generated by the LLM. The
// frontend renders this as a passive chip; it never affects state
// or triggers extra fetches.
export type InsightCacheStatus = "hit" | "miss" | "disabled";
