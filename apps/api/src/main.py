...
async def lifespan(_app: FastAPI) -> AsyncIterator[None]:
    ...
    # Credential-redaction boundary (incident 2026-07-11) — global loguru
    # patcher scrubs every message so a provider apiKey URL can never leak.
